...
class TeacherTimeIcon extends StatefulWidget {
  const TeacherTimeIcon({Key key}) : super(key: key);

  @override
  _TeacherTimeIconState createState() => _TeacherTimeIconState();
}

class _TeacherTimeIconState extends State<TeacherTimeIcon> {
