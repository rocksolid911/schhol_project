                                ...
                                child: Column(
                                  children: [
                                    Container(
                                      ...
                                      child: Text("10A",style: TextStyle(color:Colors.white,fontSize:14),)
                                    ),
                                    ...
                                    Container(
                                      ...
                                      child:Text("10B",style: TextStyle(color:Colors.white,fontSize:14),)
                                    ),
                                    ...
                                    Container(
                                      ...
                                      child:Text("10C",style: TextStyle(color:Colors.white,),)
                                    ),
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Padding(
                                                padding:  EdgeInsets.only(
                                                    right: _appConfig.rWP(3.2), left:  _appConfig.rWP(3.2), top:   _appConfig.rHP(0.5)),
                                                child: Divider(
                                                  thickness: 1,
                                                ),
                                              ),
                                                    ...
                                                    TableRow(children: [
                                                      Row(
                                                        children: [
                                                          ...
                                                          SizedBox(width:   _appConfig.rWP(9.5)),
                                                          Text(
                                                            "Chemistry",
                                                            style: TextStyle(
                                                                fontWeight:
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Row(
                                                          children: [
                                                            ...
                                                            SizedBox(  width:   _appConfig.rWP(10),),
                                                            Text(
                                                              "45",
                                                              style: TextStyle(
                                                                  fontWeight:
